...
def get_club_members(
    ...
    is_manager = current_user.role.value == UserRoleType.CLUB_MANAGER and current_user.id.value == club.manager_id #can remove first check
...
def update_club_by_id(
    ...
    is_club_manager = current_user.role == UserRoleType.CLUB_MANAGER and current_user.id == club.manager_id
